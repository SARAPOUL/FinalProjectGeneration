...
function BackToTopButton({ showButton }) {
...
const Dashboard = () => {
    ...
    //     try {
    //         const response = await axios.get(`/${path}`,{ params: { user } })
            ...
            <div className="right" >
                <div className="display-card">
                    ...
                    <Link to="/profile" className="picture-link">
                        <img src={localStorage.images} alt="Profile" className="profile-picture" />
                    </Link>
